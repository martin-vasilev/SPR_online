...
files<- list.files("Experiment2/data/raw") # get all available files in directory
files<-paste("Experiment2/data/raw/", files, sep= '') # paste full root link
...
### DEVICE DATA:
device<- LabJs_device(dat) # extract device info from lab.js
